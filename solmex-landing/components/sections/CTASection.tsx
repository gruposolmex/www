      ...
      <div className="page-shell relative z-10">
        <div className="mb-24 lg:mb-32 max-w-3xl">
          ...
          <h2 className="reveal stagger-1 font-display text-[clamp(2rem,5vw,4.5rem)] font-bold leading-[0.94] tracking-[-0.02em] uppercase mb-8 lg:mb-10">
            Registro
            <br />
            <span className="text-[#FF943B]">de la instalación.</span>
          </h2>
          <p className="reveal stagger-2 text-[#8E9192] text-lg leading-[1.88]">
            Con tipo de instalación, capacidad y ubicación se evalúa la
            compatibilidad con la red y se da curso al seguimiento. Sin dichos
            antecedentes no procede la revisión inicial.
          </p>
        </div>

        <div className="grid lg:grid-cols-12 gap-14 lg:gap-12">
          <div className="reveal stagger-2 lg:col-span-7">
            <div className="bg-[#131313] py-14 lg:py-20 px-16 lg:px-24 border border-[rgba(68,71,72,0.12)]">
              ...
              {formState === 'success' ? (
                <div className="text-center py-20 px-4">
                  ...
                  <p className="text-[#8E9192] text-sm">
                    Se establecerá contacto por correo o teléfono para la
          ...
          <div className="reveal stagger-3 lg:col-span-5 flex flex-col gap-10">
            {[
              {
                label: 'OPERADORES',
                title: 'Perfil operativo previo a la asignación',
                desc: 'Se requiere el tipo de instalación, capacidad y ubicación para evaluar encaje con la red y dar curso a la revisión.',
                items: [
                  'Sin antecedentes completos no procede la evaluación',
                  'El desempeño posterior define la posición en la coordinación',
                  'Criterios uniformes para instalaciones acreditadas',
                ],
              },
              {
                label: 'CARGADORES',
                title: 'Canal único, criterios homogéneos',
                desc: 'Ante volumen mandante, la red aplica el mismo criterio de comprobación a todos los operadores integrados.',
                items: [
                  'Marco contractual centralizado con Solmex',
                  'Evaluación de terminales con parámetros equivalentes',
                  'Reducción de coordinación bilateral repetitiva',
                ],
              },
            ].map((card) => (
              <div
                key={card.label}
                className="bg-[#131313] py-14 lg:py-20 px-16 lg:px-24 flex-1 relative overflow-hidden border border-[rgba(68,71,72,0.1)]"
              >
